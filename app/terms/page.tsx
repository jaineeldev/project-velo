...
const sections = [
  ...
  { id: "contribution-licence", title: "Contribution licence" },
  ...
  { id: "client-data-ownership", title: "Client data ownership" },
    ...
    <main className="min-h-screen bg-background">
      ...
      <div className="mx-auto max-w-3xl px-6 py-12 lg:max-w-6xl">
        <div className="lg:flex lg:gap-12">
          ...
          <p>
            We are <strong>Velo</strong> (&apos;Company&apos;, &apos;we&apos;, &apos;us&apos;,
            or &apos;our&apos;), based in Brisbane, Queensland, Australia.
          </p>
          <p>
            We operate the website <strong>velo.app</strong> (the &apos;Site&apos;), as well
          ...
          <p>
            Velo is a client workflow platform for freelance developers and dev agencies. It
            allows users to create proposals, manage client approvals, track projects, and
            generate invoices.
          </p>
          <p>
            You can contact us by email at <MailLink address="jaineelk.dev@gmail.com" />.
          </p>
          <p>
            These Legal Terms constitute a legally binding agreement made between you,
            whether personally or on behalf of an entity (&apos;you&apos;), and Velo,
          ...
          <p>
            ...
            you are using. Changes to these Legal Terms will become effective fourteen (14)
            days after the notice is given, except if the changes apply to a court order,
            security updates, and pricing changes, in which case the changes will be
            effective immediately. By continuing to use the Services after the effective
            date of any changes, you agree to be bound by the modified terms. If you
            disagree with such changes, you may terminate Services as per the section{" "}
            <a href="#term-and-termination" className={linkClass}>
          ...
          <section id="intellectual-property-rights">
            ...
            <p>
              ...
              <a href="#prohibited-activities" className={linkClass}>
            ...
            <p>
              ...
              request to: <MailLink address="jaineelk.dev@gmail.com" />. If we ever grant
            ...
            <p>
              ...
              worldwide right, and licence to: use, copy, reproduce, distribute, sell,
              ...
              sublicence the licences granted in this section. Our use and distribution may
            ...
            <p>
              ...
              <a href="#copyright-infringements" className={linkClass}>
          ...
          <section id="purchases-and-payment">
            ...
            <p>
              ...
              payments shall be in Australian Dollars (AUD).
            </p>
            <p>
          ...
          <section id="subscriptions">
            ...
            <p>
              ...
              you cancel the applicable order. The length of your billing cycle will depend
              on the type of subscription plan you choose when you subscribed to the
              Services.
            </p>
            <h3>Free trial</h3>
            <p>
              We offer a 14-day free trial to new users who register with the Services. The
            ...
            <p>
              ...
              Services, please email us at <MailLink address="jaineelk.dev@gmail.com" />.
            </p>
            <h3>Fee changes</h3>
            <p>
          ...
          <section id="prohibited-activities">
            ...
            <ul>
              ...
              <li>Use the platform to submit false or fraudulent client information.</li>
              <li>Attempt to access another user&apos;s account or client data.</li>
              <li>
                Use the platform to generate invoices or proposals for illegal services.
              </li>
              <li>
                Resell, reskin, or redistribute access to the platform as your own product.
              </li>
              <li>
                Use automated scripts or bots to scrape, crawl, or extract data from the
                platform.
              </li>
              <li>
                Impersonate another agency, business, or individual when creating proposals
                or client communications.
              </li>
              <li>
                Use the client portal share link to mislead or defraud end clients.
              </li>
            </ul>
            <BackToTop />
          </section>
          ...
          <section id="contribution-licence">
            ...
            <p>
              ...
              or otherwise change any Contributions; (2) to re-categorise any Contributions
          ...
          <section id="privacy-policy">
            ...
            <p>
              ...
              in the United States and Australia. If you access the Services from any other
              ...
              States and Australia, then through your continued use of the Services, you are
              transferring your data to the United States and Australia, and you expressly
          ...
          <section id="governing-law">
            ...
            <p>
              ...
              Australia. Velo and yourself irrevocably consent that the courts of Australia
          ...
          <section id="dispute-resolution">
            ...
            <p>
              ...
              be Brisbane, Australia. The language of the proceedings shall be English. The
              governing law of these Legal Terms shall be substantive law of Australia.
            </p>
            <h3>Restrictions</h3>
            <p>
              ...
              utilise class action procedures; and (c) there is no right or authority for
          ...
          <section id="limitations-of-liability">
            ...
            <p>
              ...
              LIMITED TO THE AMOUNT PAID, IF ANY, BY YOU TO US DURING THE SIX (6) MONTH
          ...
          <section id="client-data-ownership">
            <h2>26. Client data ownership</h2>
            <p>
              All proposal content, client information, invoices, and project data entered
              into the platform by a user remains the sole property of that user. Velo
              claims no ownership over user-generated content and will not use it for any
              purpose other than providing the service. Upon account deletion, all
              associated data will be permanently removed from our systems within 30 days.
            </p>
            <BackToTop />
          </section>
