        ...
        <div className="mt-10 flex flex-col items-stretch justify-center gap-3 sm:flex-row sm:items-center">
          ...
          {secondaryCta ? (
            <Link
              ...
              className={`inline-flex items-center justify-center rounded-xl border border-[#2A2A2A] px-8 py-3.5 text-base font-medium text-[#A0A0A0] transition-all duration-200 hover:border-[#444] hover:text-white motion-safe:hover:-translate-y-0.5 ${focusRing}`}
            >
              {secondaryCta.label}
            </Link>
          ) : null}
